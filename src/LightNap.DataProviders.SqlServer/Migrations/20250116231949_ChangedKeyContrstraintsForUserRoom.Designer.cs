...
namespace LightNap.DataProviders.SqlServer.Migrations
{
    ...
    [Migration("20250116231949_ChangedKeyContrstraintsForUserRoom")]
    partial class ChangedKeyContrstraintsForUserRoom
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LightNap.Core.Data.Entities.ChatEntities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LightNap.Core.Data.Entities.ChatEntities.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LightNap.Core.Data.Entities.ChatEntities.UserRoom", b =>
                {
                    b.HasOne("LightNap.Core.Data.Entities.ChatEntities.Room", null)
                        .WithMany()
