...
namespace LightNap.DataProviders.SqlServer.Migrations
{
    ...
    [Migration("20241203001449_UpdatedChatEntitites")]
    partial class UpdatedChatEntitites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LightNap.Core.Data.Entiies.ChatEntities.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LightNap.Core.Data.Entities.ChatEntities.UserRoom", b =>
                {
                    b.HasOne("LightNap.Core.Data.Entiies.ChatEntities.Room", null)
                        .WithMany()
